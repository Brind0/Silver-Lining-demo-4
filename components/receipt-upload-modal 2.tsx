...
export function ReceiptUploadModal({ isOpen, onClose, onSubmit }: ReceiptUploadModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Quick Upload Receipt</DialogTitle>
          <DialogDescription>
                ...
                <div className="text-center">
                  ...
                  <div className="mb-4">
                    <Label htmlFor="receipt-upload-modal" className="cursor-pointer">
                      <span className={cn(
                        "text-lg font-medium hover:underline transition-colors duration-200",
                        isDragOver ? "text-primary" : "text-primary"
                      )}>
                        {isDragOver ? "Drop receipt here" : "Click to upload receipt"}
                      </span>
